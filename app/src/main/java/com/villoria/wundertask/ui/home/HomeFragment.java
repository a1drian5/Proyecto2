package com.villoria.wundertask.ui.home;
...
import com.villoria.wundertask.NewListActivity;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        tareas = db.tareasDao().getALLTareasNoCompletadas();
        ...
        rv.setAdapter(new DemoAdapter(tareas));
